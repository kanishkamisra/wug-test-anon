...
out_dir="eacl-rebuttal/results/lr_search_4B_bs4_more45"
model="Qwen/Qwen3-VL-4B-Instruct"
inits="small:/home/user/wug-test-interp/data/embeddings/init/noun_init.txt"
existing_per_run="eacl-rebuttal/results/lr_search_4B_bs4/selected_test_per_run.csv"
...
echo "LR_SEARCH_4B_BS4_MORE45_COMPLETE"
